...
df_up_2 = pd.DataFrame({
    'is_updated': df_tabela2['is_updated'],
    'is_deleted': df_tabela2['is_deleted']
})
df_tabela2.columns = ['name' if col == 'nome' else col for col in df_tabela2.columns]
df_tabela2.columns = ['price' if col == 'preco' else col for col in df_tabela2.columns]
df_tabela2.columns = ['description' if col == 'descricao' else col for col in df_tabela2.columns]
df_tabela2 = df_tabela2.drop('dt_validade', axis=1)

df_tabela2 = df_tabela2.drop('is_deleted', axis=1)
df_tabela2 = df_tabela2.drop('is_updated', axis=1)

df_up_3 = pd.DataFrame({
    'is_updated': df_tabela3['is_updated'],
    'is_deleted': df_tabela3['is_deleted']
})
df_tabela3 = df_tabela3.drop('is_deleted', axis=1)
df_tabela3 = df_tabela3.drop('is_updated', axis=1)

df_tabela3.columns = ['name' if col == 'nome' else col for col in df_tabela3.columns]
df_tabela3.columns = ['price' if col == 'preco_moedas' else col for col in df_tabela3.columns]
df_tabela3.columns = ['store_picture_url' if col == 'imagem_loja_url' else col for col in df_tabela3.columns]
...
df_up_4 = pd.DataFrame({
    ...
    'is_deleted': df_tabela4['is_deleted']
})
df_tabela4 = df_tabela4.drop('is_deleted', axis=1)
df_tabela4 = df_tabela4.drop('is_updated', axis=1)

df_tabela4.columns = ['name' if col == 'nome' else col for col in df_tabela4.columns]
